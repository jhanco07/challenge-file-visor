...
describe('Test FileManagerService.validateLine', () => {
  it('validate line', (done) => {
    const fileManagerService = new FileManagerService()
    const lines = 'test9.csv,gLMhwlFUjDGHt,57993494542303527136947038102435,a2bc693e543e568bbf1c24c23c909ec8'
    const properties = lines.split(',')
    const res = fileManagerService.validateLine(properties, 'test9.csv')
    console.log(res)
